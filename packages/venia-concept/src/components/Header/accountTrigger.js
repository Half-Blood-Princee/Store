...
import AccountChip from '@magento/venia-concept/src/components/AccountChip';

import defaultClasses from './accountTrigger.module.css';

const AccountMenu = React.lazy(() => import('@magento/venia-concept/src/components/AccountMenu'));
